...
//  MyFirstMetalProgram
//
//  Created by Jaraffe on 2021/10/26.
//
...
struct Preferences{
    ...
    static var ambientIntensity: Float = 0.5
    static var diffuseIntensity: Float = 0.5
    static var specularIntensity: Float = 0.5
    
    static var shininess: Float = 0.5
